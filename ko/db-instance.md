...
![db-instance-detail-db-create](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-db-create-ko.png)
...
![db-instance-detail-db-modify](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-db-modify-ko.png)
...
![db-instance-detail-db-sync](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-db-sync-ko.png)
...
![db-instance-detail-db-delete](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-db-delete-ko.png)
...
![db-instance-detail-user-create](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-user-create-ko.png)
...
![db-instance-detail-user-modify](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-user-modify-ko.png)
...
![db-instance-detail-user-sync](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-user-sync-ko.png)
...
![db-instance-detail-user-delete](https://static.toastoven.net/prod_rds_postgres/20260210/db-instance-detail-user-delete-ko.png)
...
![db-instance-detail-hba-create](https://static.toastoven.net/prod_rds_postgres/20260414/db-instance-detail-hba-create-ko.png)
...
![db-instance-detail-hba-create-by-text](https://static.toastoven.net/prod_rds_postgres/20260414/db-instance-detail-hba-create-by-text-ko.png)
...
![db-instance-deletion-protection](https://static.toastoven.net/prod_rds_postgres/20240813/db-instance-list-deletion-protection-ko.png)

❶ 삭제 보호 설정을 변경하려는 DB 인스턴스를 선택 후 드롭다운 메뉴에서 **삭제 보호 설정 변경** 메뉴를 클릭하면 팝업 창이 나타납니다.

![deletion-protection-popup](https://static.toastoven.net/prod_rds_postgres/20240813/db-instance-list-deletion-protection-popup-ko.png)
...
![db-instance-ha-failover-repair](https://static.toastoven.net/prod_rds_postgres/20241210/db-instance-ha-failover-repair-ko.png)
...
![db-instance-ha-failover-rebuild](https://static.toastoven.net/prod_rds_postgres/20241210/db-instance-ha-failover-rebuild-ko.png)
...
![db-instance-ha-failover-split](https://static.toastoven.net/prod_rds_postgres/20241210/db-instance-ha-failover-split-ko.png)
...
![db-instance-ha-wait-manual-failover](https://static.toastoven.net/prod_rds_postgres/20241210/db-instance-ha-wait-manual-failover-ko.png)
