...
![backup-config](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20241210/backup-config-en.png)
...
![db-instance-detail-backup](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-detail-backup-en.png)
...
![backup-create](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20241210/backup-create-en.png)
...
![backup-config](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20240611/backup-config-en.png)
...
![db-instance-list-export-obs](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-list-export-obs-en.png)

![db-instance-list-export-obs-modal](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-list-export-obs-modal-en.png)
...
![db-instance-detail-backup-export](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-detail-backup-export-en.png)
...
![backup-export](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20241210/backup-export-en.png)
...
![db-instance-detail-backup-restore](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-detail-backup-restore-en.png)
...
![backup-restore](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20241210/backup-restore-en.png)
...
![db-instance-pitr](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-pitr-en.png)
...
![db-instance-pitr-timestamp](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20260609/db-instance-pitr-timestamp-en.png)
...
(1) See [Export Backup File](backup-and-restore-ngovc/#_5) to export a backup of RDS for PostgreSQL to object storage.
...
![backup-obs-restore](https://static-station.ngovc.com/v1/AUTH_3365819a41194e7ca358853f5b2eec52/cdn/prod_rds_postgres/20241210/backup-obs-restore-en.png)
...
❺ Enter the path to the backup that will be stored in the container. The folder name can be up to 255 bytes, and the full path can be up to 1024 bytes. You cannot use certain forms (. or ..), and you cannot enter special characters (' " < > ;) and spaces.
❻ Refer to the [Create DB instance](db-instance-ngovc/#db_1) section to enter the remaining settings and click the **Restore to Backup in Object Storage** button.