...
## Common Information on RDS for PostgreSQL API { #rds-for-postgresql-api-2 }
...
### Authentication and Authorization { #rds-for-postgresql-api-2-1 }
...
### Common Response Information { #rds-for-postgresql-api-2-2 }
...
<a id="db-2"></a>
### Supported DB Engine Versions { #db-2 }
...
<a id="db-3"></a>
### View DB Engine Version List { #db-3 }
...
<a id="db-4"></a>
## Specifications of DB Instance { #db-4 }

<a id="db-4-db"></a>
### List DB Instance Specifications { #db-4-db }
...
<a id="section-1-1"></a>
### List Project Members { #section-1-1 }
...
<a id="section-3-1"></a>
### View the List of Storage Types { #section-3-1 }
...
<a id="section-4"></a>
## Task Information { #section-4 }

<a id="section-4-1"></a>
### Task Status { #section-4-1 }
...
<a id="db-5"></a>
## DB Instance Group { #db-5 }

<a id="db-5-db"></a>
### List DB Instance Groups { #db-5-db }
...
<a id="db-5-db-5"></a>
### List DB Instance Group Details { #db-5-db-5 }
...
<a id="db-5-2"></a>
### Apply Extension Changes { #db-5-2 }
...
<a id="db-5-4"></a>
### Delete Extension (Cancel) { #db-5-4 }
...
<a id="db-6-db-2"></a>
### DB Instance Progress Status { #db-6-db-2 }
...
<a id="db-6-db-5"></a>
### Restore DB Instance from Backup in Object Storage { #db-6-db-5 }
...
<a id="db-6-db-7"></a>
### List DB Instance Details { #db-6-db-7 }
...
<a id="db-6-db-9"></a>
### Apply Latest Parameter Group to DB Instance { #db-6-db-9 }
...
<a id="dbdb"></a>
### Get selectable DB engine versions in the current DB instance { #dbdb }
...
<a id="db-6-db-11"></a>
### Get DB Instance Backup Information { #db-6-db-11 }
...
<a id="db-6-db-12"></a>
### Modify DB Instance Backup Information { #db-6-db-12 }
...
<a id="db-6-db-13"></a>
### Export after Backing up DB Instance to Object Storage { #db-6-db-13 }
...
<a id="db-6-1"></a>
### View the list of databases { #db-6-1 }
...
<a id="db-6-db-14"></a>
### Change DB Instance Deletion Protection Settings { #db-6-db-14 }
...
<a id="db-6-db-15"></a>
### Force Restart DB Instance { #db-6-db-15 }
...
<a id="db-6-9"></a>
### View a list of access control rules { #db-6-9 }
...
<a id="db-6-10"></a>
### Add Access Control Rules { #db-6-10 }
...
<a id="db-6-11"></a>
### Apply Access Control Rules { #db-6-11 }
...
<a id="db-6-12"></a>
### Reorder Access Control Rules { #db-6-12 }
...
<a id="db-6-13"></a>
### Delete Access Control Rules { #db-6-13 }
...
<a id="db-6-14"></a>
### Modify Access Control Rules { #db-6-14 }
...
<a id="db-6-15"></a>
### Get high availability information { #db-6-15 }
...
<a id="db-6-16"></a>
### Modify High Availability { #db-6-16 }
...
<a id="db-6-17"></a>
### Pause High Availability { #db-6-17 }
...
<a id="db-6-18"></a>
### Recover High Availability { #db-6-18 }
...
<a id="db-6-19"></a>
### Restart High Availability { #db-6-19 }
...
<a id="db-6-20"></a>
### Separate High Availability { #db-6-20 }
...
<a id="db-6-db-16"></a>
### Get DB instance maintenance information { #db-6-db-16 }
...
<a id="db-6-db-17"></a>
### Modify DB instance maintenance information { #db-6-db-17 }
...
<a id="db-6-db-18"></a>
### Get DB instance network information { #db-6-db-18 }
...
<a id="db-6-db-19"></a>
### Modify DB instance network information { #db-6-db-19 }
...
<a id="db-6-db-20"></a>
### Promote DB Instance { #db-6-db-20 }
...
<a id="db-6-db-21"></a>
### Restart DB Instance { #db-6-db-21 }
...
<a id="db-6-db-22"></a>
### Get DB Instance Restore Information { #db-6-db-22 }
...
<a id="db-6-db-23"></a>
### Restore DB Instance { #db-6-db-23 }
...
<a id="db-6-db-26"></a>
### Get DB Instance Storage Information { #db-6-db-26 }
...
<a id="db-6-db-27"></a>
### Modify DB Instance Storage Information { #db-6-db-27 }
...
<a id="section-5-2"></a>
### Retrieve Backup List { #section-5-2 }
...
<a id="section-5-4"></a>
### Export Backup to Object Storage { #section-5-4 }
...
<a id="db-7"></a>
## DB Security Group { #db-7 }

<a id="db-7-db"></a>
### DB Security Group Progress Status { #db-7-db }
...
<a id="db-7-db-2"></a>
### List DB Security Groups { #db-7-db-2 }
...
<a id="db-7-db-3"></a>
### Create DB Security Group { #db-7-db-3 }
...
<a id="db-7-db-4"></a>
### Delete DB Security Group { #db-7-db-4 }
...
<a id="db-7-db-5"></a>
### List DB Security Group Details { #db-7-db-5 }
...
<a id="db-7-db-6"></a>
### Modify DB Security Group { #db-7-db-6 }
...
<a id="db-7-db-7"></a>
### Delete DB Security Group Rule { #db-7-db-7 }
...
<a id="db-7-db-8"></a>
### Create DB Security Group Rule { #db-7-db-8 }
...
<a id="db-7-db-9"></a>
### Modify DB Security Group Rule { #db-7-db-9 }
...
<a id="section-6"></a>
## Parameter group { #section-6 }

<a id="section-6-1"></a>
### List Parameter Groups { #section-6-1 }
...
<a id="section-6-2"></a>
### Create Parameter Group { #section-6-2 }
...
<a id="section-6-3"></a>
### Delete Parameter Group { #section-6-3 }
...
<a id="section-6-4"></a>
### List Parameter Group Details { #section-6-4 }
...
<a id="section-6-5"></a>
### Modify Parameter Group { #section-6-5 }
...
<a id="section-6-6"></a>
### Copy Parameter Group { #section-6-6 }
...
<a id="section-6-8"></a>
### Reset Parameter Group { #section-6-8 }
...
<a id="section-7"></a>
## User Group { #section-7 }

<a id="section-7-1"></a>
### List User Groups { #section-7-1 }
...
<a id="section-7-4"></a>
### List User Group Details { #section-7-4 }
...
<a id="section-8"></a>
## Notification Groups { #section-8 }

<a id="section-8-1"></a>
### List Notification Groups { #section-8-1 }
...
<a id="section-8-2"></a>
### Create Notification Group { #section-8-2 }
...
<a id="section-8-3"></a>
### Delete Notification Group { #section-8-3 }
...
<a id="section-8-4"></a>
### View Notification Group Details { #section-8-4 }
...
<a id="section-8-5"></a>
### Modify Notification Group { #section-8-5 }
...
<a id="section-8-6"></a>
### List Watch Settings { #section-8-6 }
...
<a id="section-8-7"></a>
### Create Watch Setting { #section-8-7 }
...
<a id="section-8-8"></a>
### Delete Watch Setting { #section-8-8 }
...
<a id="section-8-9"></a>
### Modify Watch Setting { #section-8-9 }
...
<a id="section-9-2"></a>
### View a list of performance metrics { #section-9-2 }
...
<a id="section-10-2"></a>
### List subscribable event codes { #section-10-2 }
...
<a id="section-10-3"></a>
### View the list of events { #section-10-3 }
