...
A parameter group is a set of parameters that allow you to set up a database installed on a DB instance. You must select one parameter group when you create a DB instance. The parameter group can be changed freely even after it is created. For a detailed description of the parameter group, refer to [Parameter Group](parameter-group-ngoic/).

### DB Security Group

DB security groups are used to restrict access against outside break-in. You can allow access to specific port ranges or database ports for incoming and outgoing traffic. You can apply multiple DB security groups to a DB instance. For a detailed description of DB security groups, refer to [DB security groups](db-security-group-ngoic/).

### Backup

You can set up a database of DB instances to periodically back up, or you can create backups at any time with console. During the backup, the performance might degrade. We recommended that you back up at a time when the service load is not high so as not to affect the service. If you don't want performance degradation from backups, you can perform backups on a read replica. Backup files are stored in internal backup storage and are charged based on backup capacity. We recommend that you enable periodic backups to prepare for unexpected failures. For a detailed description of backups, see [Backup and Restore](backup-and-restore-ngoic/).
...
You can set default notifications when creating a DB instance. Setting default notifications creates a new notification group with `{DB instance name}-default` name and automatically sets the notification items below. You can freely modify and delete notification groups generated by default notifications. See [Notification Groups](notification-ngoic/) for a detailed description of notification groups.
...
![db-instance-list-basic](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-basic-en.png)
...
![db-instance-list-filter](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-filter-en.png)
...
![db-instance-detail-basic](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-basic-en.png)
...
![db-instance-detail-log](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-log-en.png)
...
![db-instance-detail-db-create](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-db-create-en.png)
...
![db-instance-detail-db-modify](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-db-modify-en.png)
...
![db-instance-detail-db-sync](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-db-sync-en.png)
...
![db-instance-detail-db-delete](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-db-delete-en.png)
...
![db-instance-detail-schema-modify](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-schema-modify-en.png)
...
![db-instance-detail-user-create](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-user-create-en.png)
...
![db-instance-detail-user-modify](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-user-modify-en.png)
...
![db-instance-detail-user-sync](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-user-sync-en.png)
...
![db-instance-detail-user-delete](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-user-delete-en.png)
...
![db-instance-detail-user-delete-with-option](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-user-delete-with-option-en.png)
...
![db-instance-detail-hba](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-hba-en.png)
...
![db-instance-detail-hba-create](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-hba-create-en.png)
...
![db-instance-detail-hba-create-by-text](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-hba-create-by-text-en.png)
...
![db-instance-detail-hba-modify](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-hba-modify-en.png)
...
![db-instance-detail-hba-delete](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-hba-delete-en.png)
...
![db-instance-detail-extension-install](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-extension-install-en.png)
...
![db-instance-detail-extension-delete](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-extension-delete-en.png)
...
![db-instance-detail-extension-sync](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-detail-extension-sync-en.png)
...
![modify-ha-popup](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260414/modify-ha-popup-en.png)

If you do not use restart with failover, the changes are applied sequentially to the master and candidate master, and then the DB instance is restarted. For more information, see [Manual Failover Items](db-instance-ngoic/#_7) in High Availability DB Instances.
...
You can prepare a database of DB instances to recover in case of a failure. You can perform backups from the console whenever you need to or you can set to perform periodical back up. See [Backup](backup-and-restore-ngoic/#_1) for more information.

## Restoration

You can use backup to restore data to any point in time. Restore always creates a new DB instance and cannot be restored to an existing DB instance. See [Backup](backup-and-restore-ngoic/#_6) for more information.
...
![db-instance-list-apply-parameter-group](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-apply-parameter-group-en.png)
...
![db-instance-list-apply-parameter-group-popup](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-apply-parameter-group-popup-en.png)
...
![db-instance-list-apply-parameter-group-compare-popup](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-apply-parameter-group-compare-popup-en.png)

## Export Backup Files to Object Storage after Backup

After backing up, you can export the backup file to user object storage in NHN Cloud. For details, see [Export Backup Files](backup-and-restore-ngoic/#_5).

## Restore Using Backup in Object Storage

You can restore to a DB instance using a backup file exported from RDS for PostgreSQL to object storage. For more information, see [Restore using Backup in Object Storage](backup-and-restore-ngoic/#_7).
...
![db-instance-list-replica-create](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-replica-create-en.png)
...
When selecting a parameter group for a read replica, we recommend that you select the same parameter group as the source DB instance unless you need to change any replication-related settings. For a detailed description of parameter groups, see [Parameter Group](parameter-group-ngoic/).

#### DB Security Group

Select the DB security group to apply to the read replica. The rules required for replication are applied automatically, so you do not need to add them to the DB security group. For a detailed description of DB security groups, see [DB Security Group](db-security-group-ngoic/).

#### Backup

Select the backup settings for the read replica. For a detailed description of backups, see [Backup and Restore](backup-and-restore-ngoic/).
...
![db-instance-list-stop-wait-replication-lag](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-stop-wait-replication-lag-en.png)
...
![db-instance-list-restart](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-restart-en.png)
...
![db-instance-list-force-restart](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-force-restart-en.png)
...
![db-instance-deletion-protection](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-deletion-protection-en.png)
...
![deletion-protection-popup](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-list-deletion-protection-popup-en.png)
...
![db-instance-ha-failover-repair](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-ha-failover-repair-en.png)
...
![db-instance-ha-failover-rebuild](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-ha-failover-rebuild-en.png)
...
![db-instance-ha-failover-split](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-ha-failover-split-en.png)
...
![db-instance-ha-wait-manual-failover](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-ha-wait-manual-failover-en.png)
...
![db-instance-planned-migration](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-planned-migration-en.png)

You can check the detailed schedule of maintenance by putting the mouse pointer over the migration button.

![db-instance-planned-migration-popup](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-planned-migration-popup-en.png)
...
![db-instance-planned-migration-confirm](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-planned-migration-confirm-en.png)

#### 4. Wait for DB instance migration to finish.

If the DB instance status does not change, click **Refresh**.

![db-instance-planned-migration-status](https://static-station.ngoic.com/v1/AUTH_c8bd5293535a46f8bc6705b349f67ea3/cdn/prod_rds_postgres/20260609/db-instance-planned-migration-status-en.png)
