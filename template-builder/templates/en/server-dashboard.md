...
![server-dashboard-layout]({{url.cdn}}/20240813/server-dashboard-layout-{{lang}}.png)
...
![server-dashboard-chart-add]({{url.cdn}}/20240813/server-dashboard-chart-add-{{lang}}.png)
...
![server-dashboard-chart-manage]({{url.cdn}}/20240813/server-dashboard-chart-manage-{{lang}}.png)
...
![server-dashboard-group-add]({{url.cdn}}/20240813/server-dashboard-group-add-{{lang}}.png)
...
![server-dashboard-group-manage]({{url.cdn}}/20240611/server-dashboard-group-manage-{{lang}}.png)
...
![server-dashboard-group-menu]({{url.cdn}}/20240611/server-dashboard-group-menu-{{lang}}.png)
