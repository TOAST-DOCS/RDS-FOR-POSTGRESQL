...
![user-group-create]({{url.cdn}}/20240813/user-group-create-{{lang}}.png)
...
![user-group-custom]({{url.cdn}}/20240813/user-group-custom-{{lang}}.png)
...
![notification-group.png]({{url.cdn}}/20240813/notification-group-{{lang}}.png)
...
![notification-group-watchdog]({{url.cdn}}/20240813/notification-group-watchdog-{{lang}}.png)
