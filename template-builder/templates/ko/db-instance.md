...
RDS for PostgreSQL에서는 데이터베이스와 사용자를 손쉽게 관리할 수 있도록 콘솔에서 관리 기능을 제공하지만, 사용자가 직접 제어할 수 있도록 설정하는 기능도 제공합니다. 직접 제어를 사용하면 현재 생성된 모든 DDL 사용자에게 `CREATEDB`, `CREATEROLE` 권한을 부여합니다. 기존 사용자의 권한을 DDL로 수정하거나 신규 생성시에도 동일하게 부여합니다.
